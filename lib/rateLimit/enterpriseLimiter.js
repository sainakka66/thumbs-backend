...
const limiters = {
  ...
  mfaOtpSend: createEnterpriseLimiter({ name: 'mfa_otp_send' }),
  mfaOtpVerify: createEnterpriseLimiter({ name: 'mfa_otp_verify' }),
  emailVerifySend: createEnterpriseLimiter({ name: 'email_verify_send' }),
};
